...
import 'package:utils_vgaia/extension/num.dart';
import 'package:utils_vgaia/extension/string.dart';
...
class ReplaceDecimalFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(
    ...
    return newValue.copyWith(
        text: newValueText,
        selection: newValue.selection.copyWith(
            baseOffset: countIndex.toInt(), extentOffset: countIndex.toInt()));
  }
}
  ...
  TextEditingValue formatEditUpdate(
    ...
    if (_exp.hasMatch(newValue.text)) {
      ...
      final String formattedString =
          newText.replaceAll(':', '').padRight(6, '0');
      ...
      return TextEditingValue(
        text: value,
        selection:
            newValue.selection.copyWith(baseOffset: index, extentOffset: index),
        composing: TextRange.empty,
      );
    }
