...
DateTime getCurrentDateTimeWithCustomTime(String? timeString,
    {DateTime? timeNow, String type = 'HH:mm:ss'}) {
  try {
...
DateTime getCurrentDateTimeWithCustomTime2(String timeString,
    {DateTime? timeNow}) {
  try {
    final DateTime now = timeNow ?? DateTime.now();
