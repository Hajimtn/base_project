import 'package:common/base/base_mixin.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '@${user.username}',
                          style: textStyle.regular(color: Colors.grey, size: 14),
                        ),
                      ],
                    ),
                  ),
              ...
              SizedBox(height: 8),
              _buildInfoRow(Icons.location_on, '${user.address.city}, ${user.address.street}'),
              SizedBox(height: 8),
