...
///
/// An implementation of [NumberInputFormatterUtils] automatically inserts thousands
/// separators to numeric input. For example, a input of `1234` should be
/// formatted to `1,234`.
///
class ThousandsFormatter extends NumberInputFormatterUtils {
...
///
/// An implementation of [NumberInputFormatterUtils] that converts a numeric input
/// to credit card number form (4-digit grouping). For example, a input of
/// `12345678` should be formatted to `1234 5678`.
///
class CreditCardFormatter extends NumberInputFormatterUtils {
...
///
abstract class NumberInputFormatterUtils extends TextInputFormatter {
