...
import 'package:base_project/core/utils/api_error.dart';
import 'package:base_project/core/utils/app_config.dart';
import 'package:base_project/core/utils/interceptors.dart';
import 'package:base_project/core/utils/api_response.dart';
...
class RestClient {
  RestClient(this.baseUrl, List<Interceptor>? interceptors) {
    final BaseOptions options = BaseOptions(
      baseUrl: baseUrl,
      connectTimeout: Duration(seconds: AppConfig.connectTimeout),
      receiveTimeout: Duration(
          seconds: AppConfig.receiveTimeout),
  ...
  Future<dynamic> getDataChart(String path,
      {Map<String, dynamic>? queryParameters,
      Options? options,
      CancelToken? cancelToken,
      ProgressCallback? onReceiveProgress}) async {
  ...
  Future<dynamic> getFullResponse(String path,
      {Map<String, dynamic>? queryParameters,
      Options? options,
      CancelToken? cancelToken,
      ProgressCallback? onReceiveProgress}) async {
      ...
      switch (e.type) {
        ...
        case DioExceptionType.badResponse:
          ...
          if (code == '500' ||
              ...
              code == '503') {
            return ApiError(
                errorCode: code, message: '$errorString} ${_getCode(code)}');
          }
          ...
          if (code == '400' &&
            ...
            final ApiResponse apiResponse =
                ApiResponse.fromJson(e.response?.data as Map<String, dynamic>);
            return ApiError(
